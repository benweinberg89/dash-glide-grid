...
- cellsToUpdate (list of list of numberss; optional):
    Array of cell coordinates to selectively update/redraw. Each item
    is a [col, row] tuple. When this prop changes, only the specified
    cells are redrawn (much more efficient than redrawTrigger which
    redraws the entire canvas). Example: [[0, 5], [1, 5], [2, 5]].
...
- width (number | string; default '100%'):
    ...
    def __init__(
        ...
        cellsToUpdate: typing.Optional[typing.Sequence[typing.Sequence[NumberType]]] = None,
