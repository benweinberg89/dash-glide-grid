...
- lastUpdatedCells (dict; optional):
    ...
    strings, values are performance.now() timestamps. Example:
    {\"0,2\": 1709234567.89, \"3,4\": 1709234567.89}  Note:
