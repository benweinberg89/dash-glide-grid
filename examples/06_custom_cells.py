...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Ul([
            html.Li('Dropdown cells: Click to select from predefined options (Status, Priority columns)'),
            html.Li('MultiSelect with options: Select multiple items with color-coded badges (Tags column)'),
            html.Li('MultiSelect without options: Create custom tags on-the-fly (Categories column)'),
...
@callback(
    ...
    Input('custom-cells-grid', 'cellEdited')
)
